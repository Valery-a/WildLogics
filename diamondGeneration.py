...
def get_terrain_color_array(size_of_terrain, roughness_delta):
    n = size_of_terrain    # Edge size of the resulting image in pixes
    ds = roughness_delta        # Roughness delta, 0 < ds < 1 : smaller ds => smoother results
    ...
    return colors, image.width, image.height
